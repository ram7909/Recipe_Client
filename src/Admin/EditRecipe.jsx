...
const EditRecipe = () => {
        ...
        const fetchDataFromAPI = async () => {
            ...
            if (recipe) {
                setFormData({
                    ...
                    multiple_img: recipe.multiple_img
                })
            }
        }
        fetchDataFromAPI()
    ...
    const editRecipe = async (name, description, ingredients, cook_time, img, fat, carbs, protein, category, multiple_img) => {
        if(!admin){
            return null
          }
        const api = await axios.put(`${url}/reciepe/edit/${id}`, {
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await editRecipe(name, description, ingredients, cook_time, img, fat, carbs, protein, category, multiple_img)
        if(!admin){
